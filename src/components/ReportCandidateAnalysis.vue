...
const bank = computed(() => activeCandidate.value?.formulaVersion === 'bank-health-3f-v1')
const factors = computed(() => activeCandidate.value ? bank.value ? [
  { label: 'ROE', value: activeCandidate.value.scoreBreakdown?.profitability, weight: '40%' },
  { label: 'Capital-to-RWA proxy', value: activeCandidate.value.scoreBreakdown?.solvency, weight: '40%' },
  { label: 'P/BV', value: activeCandidate.value.scoreBreakdown?.valuation, weight: '20%' }
] : [
