...
<template>
  <div class="page-shell space-y-8">
    <header class="rounded-3xl bg-[#102138] p-7 text-white sm:p-10"><p class="text-xs font-semibold text-blue-200">Workspace riset finansial</p><h1 class="mt-4 max-w-3xl text-3xl font-bold tracking-tight sm:text-4xl">Temukan kandidat untuk diteliti lebih lanjut</h1><p class="mt-5 max-w-2xl text-sm leading-7 text-slate-300">Screening IDX dengan tiga faktor: profitabilitas, solvabilitas, dan valuasi. Maksimal delapan simbol pertama provider diperiksa; bukan pencarian seluruh pasar.</p><router-link to="/research/new" class="button-primary mt-6">Susun riset</router-link><p class="mt-4 max-w-2xl text-xs leading-6 text-slate-300">Kesehatan bank, keberlanjutan dividen, pertumbuhan, dan peer sektor belum didukung. Skor bukan peluang untung.</p></header>
