...
const isBank = computed(() => store.report.contract?.objectiveType === 'bank-filter' || store.candidates.some(candidate => candidate.formulaVersion === 'bank-filter-v1'))
